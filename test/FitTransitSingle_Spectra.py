...
#            pass
    ...
    if MCMC:
        ...
        numpy.savez('./FitTransitSingle_Spectra'+str(FitParams['SpecNo']).zfill(2)+'.npz', bestfit=outputdict, labels=labels, chain=sampler.chain, flatchain=MCMCresults, lnprob=sampler.lnprobability, flatlnprob=sampler.flatlnprobability,
...
numpy.savez('./FitTransitSingle_Spectra.npz', FitOutput=FitOutput)
